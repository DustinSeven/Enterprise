...
#import "TTBContactViewIphone.h"

@implementation TTBContactViewIphone
...
- (void)layoutSubviews
{
    self.frame = CGRectMake(0, HeadViewHeight, SCREEN_WIDTH, SCREEN_HEIGHT - TabBarHeight - HeadViewHeight);
    self.baseTableView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - TabBarHeight - HeadViewHeight);
}
@end
