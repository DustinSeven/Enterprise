...
#import "TTBContactController.h"
#import "TTBContactCell.h"
#import "TTBContactEntity.h"

@interface TTBContactController ()<UITableViewDelegate,UITableViewDataSource,SWTableViewCellDelegate>
{
    TTBContactViewBase *_baseView;
...
@implementation TTBContactController
...
- (void)viewDidLoad
{
    ...
    if(IS_PHONE)
    {
        _baseView = [[TTBContactViewIphone alloc]init];
        self.view = _baseView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TTBContactCell *cell = (TTBContactCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if(cell == nil)
    {
        cell = [[TTBContactCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
        cell.rightUtilityButtons = [self rightButtons];
        cell.delegate = self;
    }

    TTBContactEntity *entity = [[sectionsArray objectAtIndex:indexPath.section]objectAtIndex:indexPath.row];
...
{
    TTBContactCell *cell = (TTBContactCell *)[tableView cellForRowAtIndexPath:indexPath];
    cell.selected = NO;
