...
#import "TTBGuideInterfaceViewIphone.h"

@interface TTBGuideInterfaceViewIphone()

@end

@implementation TTBGuideInterfaceViewIphone
...
//    self.scrollView.bouncesZoom = NO;
    ...
    [self.enterBtn setBackgroundImage:[TTBUtility imageWithColor:GuidePageJoinBtnColorNormal size:CGSizeMake(GuideInterfaceEnterButtonWidth, GuideInterfaceEnterButtonHeight)] forState:UIControlStateNormal];
    [self.enterBtn setBackgroundImage:[TTBUtility imageWithColor:GuidePageJoinBtnColorPressed size:CGSizeMake(GuideInterfaceEnterButtonWidth, GuideInterfaceEnterButtonHeight)] forState:UIControlStateHighlighted];
