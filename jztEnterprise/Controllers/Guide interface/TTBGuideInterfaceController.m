...
#import "TTBGuideInterfaceController.h"
#import "TTBGuideInterfaceViewIphone.h"
#import "TTBMainPageController.h"

@interface TTBGuideInterfaceController ()<UIScrollViewDelegate>
{
    TTBGuideInterfaceViewBase *_baseView;
...
@implementation TTBGuideInterfaceController
...
- (void)viewDidLoad {
    ...
    if(IS_PHONE)
    {
        ...
        _baseView = [[TTBGuideInterfaceViewIphone alloc]init];
